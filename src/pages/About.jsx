...
const About = () => {
    const resumePdfPath = '/Md_Sifat_Ikram_Resume.pdf'; // Path to resume PDF in public folder
    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={handleDownloadClick} className='flex items-center gap-3 px-4 py-2 mt-8 font-semibold text-white bg-[#121A90] rounded-xl'><FaCloudDownloadAlt className='text-lg' /> <span className="text-xl">Download Resume</span></button>
            </div>
        </div>
    );
};
