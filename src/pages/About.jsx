    ...
    return (
        <div className="ml-10">
            <button className='flex items-center gap-2 px-4 py-2 mb-10 border-2 border-solid rounded-full cursor-pointer hover:text-white hover:bg-sky-700'>
                <IoPerson />
                <h1 className='font-medium uppercase max-md:text-sm'>About Me</h1>
            </button>
            <div>
                <h1 className='mb-8 text-base font-semibold md:text-2xl lg:text-3xl'>
                    Every great design begin with an even better story
                </h1>
                <h2  className='mb-5 text-sm md:text-lg lg:text-2xl'>
                ...
                <button onClick={handleDownloadClick} className='flex items-center gap-3 px-4 py-2 mt-8 font-semibold text-white bg-sky-700 rounded-xl'><FaCloudDownloadAlt className='text-lg' /> <span className="lg:text-2xl max-md:text-xs md:text-lg">Download Resume</span></button>
            </div>
        </div>
    );
};
