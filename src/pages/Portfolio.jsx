        ...
        <div className="ml-10">
            ...
            <div>
                ...
                <div className='grid grid-cols-1 gap-3 mt-10 lg:grid-cols-2'>
                    <a className="py-5 space-y-5 border-2 border-solid rounded-md hover:border-sky-700 md:p-5 lg:p-7 bg-base-200" href='https://job-hustle.web.app/'>
                    ...
                    <a className="py-5 space-y-5 border-2 border-solid rounded-md hover:border-sky-700 md:p-5 lg:p-7 bg-base-200" href='https://6533c61dbfae0c6c5b4fc7a9--wondrous-muffin-cf0e61.netlify.app/'>
                    ...
                    <a className="py-5 space-y-5 border-2 border-solid rounded-md hover:border-sky-700 md:p-5 lg:p-7 bg-base-200" href='https://swiftscan-diagnostics.web.app/'>
